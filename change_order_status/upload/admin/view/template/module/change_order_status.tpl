      ...
      <div class="panel-body">
		...
		<form action="<?php echo $form_action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
              <textarea name="change_order_status_text" placeholder="<?php echo $entry_text; ?>" id="input-description" class="form-control"><?php echo $change_order_status_text; ?></textarea>
            </div>
		  </div>
          ...
          <div class="form-group">  
            ...
            <div class="col-sm-10">
              <select name="change_order_status_status" id="input-status" class="form-control">
                <?php if ($change_order_status_status) { ?>
